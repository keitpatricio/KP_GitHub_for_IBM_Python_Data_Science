...
#     if entered_site == 'ALL':
#         fig = px.pie(data=spacex_df, 
#             values='class', 
#             names='Launch Site', 
#             title='Pie Chart of Launch Sites')
#         return fig
#         #check notes for class =1 and class =0
#     else:
#         fig = px.pie(data=spacex_df['Launch Site'] == entered_site, 
#             values='class', 
#             names='Launch Site', 
#             title='Pie Chart of Launch Sites')
#         return fig
...
#     else:
#         fig = px.scatter(
#             data=spacex_df['Launch Site'] == entered_site, 
#             x='Payload Mass (kg)',
#             y='class', 
#             color='Booster Version Category'
#             )
